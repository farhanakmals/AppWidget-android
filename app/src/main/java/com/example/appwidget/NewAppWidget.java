...
public class NewAppWidget extends AppWidgetProvider {
    ...
    private static final String mSharedProfile = "com.example.appwidget";
    ...
    static void updateAppWidget(Context context, AppWidgetManager appWidgetManager,
        ...
        // menampilkan new widget
        views.setTextViewText(R.id.applayout_id, String.valueOf(appWidgetId));

        // sharedPreferences (untuk membedakan dengan widget lain)
